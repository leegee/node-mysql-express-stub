...
/**
  ...
  * @param args {Object}
  * @param args.table {String} The table from which to select.
  * @param args.onRow {function} Called for every row, with an argument of the JSON-stringified result. Useful for immediate rendering of results.
  * @param args.onEnd {function} Called after all results are gathered, and the DBH is released.
  * @param args.onError {function} Called with the error, after the DBH has been released.
  * @returns {Array} List of results.
  */
...
/**
  * Gather metadata about a table from the <code>INFORMATION_SCHEMA</code>.
  * @param table {String} The name of the subject table.
  * @param next {function} The next middleware callback.
  * @Returns {Array} An array (for consitency) of one member, an object with
  * two keys, <code>table</code> and <code>columns</code>, to provide information
  * from the information schema and a 'full columns' query, respectively.
  */
